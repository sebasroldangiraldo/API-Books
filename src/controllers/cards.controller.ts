export class CardTemplateController {
    ...
    render(id : string, title : string, author : string, description : string, summary : string, publicationDate : string) : void { // método para renderizar(representar graficamente) los libros.
